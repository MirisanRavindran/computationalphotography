...
previewButton.addEventListener("click", (e) => {
  ...
  // Set preview image with grayscale filter
  previewImage.src = image.src;
  previewImage.style.filter = "grayscale(100%)";

  // Create a canvas and draw the grayscale image on it
  ...
  let grayscaleDataURL = canvas.toDataURL("image/png");
  downloadButton.href = grayscaleDataURL;
  downloadButton.download = `grayscale_${fileName}.png`;
});
